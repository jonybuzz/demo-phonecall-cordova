    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        //if (android.os.Build.VERSION.SDK_INT >= 23) {
            phoneAccount = new PhoneAccount.Builder(handle, appName)
                    ...
                    .setCapabilities(PhoneAccount.CAPABILITY_CONNECTION_MANAGER) //hasta aca lanza la llamada pero no oculta porque no usa MyConnectionService
...
//        }
    ...
    private void sendCall() {
        Uri uri = Uri.fromParts("tel", "1164534543", null);
...
//          this.cordova.getActivity().getApplicationContext().startActivity(intent);
            Uri uri = Uri.fromParts("tel", realCallTo, null);
            Bundle callInfoBundle = new Bundle();
            callInfoBundle.putString("to", realCallTo);
            Bundle callInfo = new Bundle();
            callInfo.putParcelable(TelecomManager.EXTRA_OUTGOING_CALL_EXTRAS, callInfoBundle);
            callInfo.putParcelable(TelecomManager.EXTRA_PHONE_ACCOUNT_HANDLE, handle);
